    ...
    <html lang="en">
      <body>
        ...
        <div className="flex w-screen h-screen px-10 pt-10 pb-12">
          <div className={`w-3/4 rounded-3xl bg-black text-4xl outline-none shadow-lg ${Math.random() < .5 ? 'shadow-[#FF5733]' : 'shadow-[#3380FF]'} border border-white relative`}>
            <div className="w-full h-28 bg-gradient-to-b from-black from-50% to-transparent absolute top-0 left-0 z-10 rounded-3xl">
              <p className="text-7xl px-6 pt-4 pb-2"><span className="font-copula">formatic</span><span className="font-waffold">FOBS</span></p>

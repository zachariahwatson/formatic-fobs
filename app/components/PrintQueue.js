                            ...
                            >
                                <div className="w-full bg-gradient-to-b from-black from-50% to-transparent absolute top-0 left-0 z-10 rounded-3xl">
                                    <p className="text-2xl px-4 pt-2">
                                        <span className="font-n27-extralight">STATUS_</span><span className="font-n27-regular">{job.Status}</span><span className="font-n27-regular float-right pt-1">{job.ID}</span><span className="font-n27-extralight float-right pt-1">ID_</span>
                                    </p>
                ...
                >
                    <div className="w-full h-28 bg-gradient-to-b from-black from-50% to-transparent absolute top-0 left-0 z-10 rounded-3xl">
                        <p className="text-4xl mb-px px-4 pb-2 pt-4">
                            <span className="font-n27-extralight">STATUS_</span><span className="font-n27-regular">{currentJob && currentJob.Status ? currentJob.Status : 'WAITING'}</span><span className="font-n27-regular float-right pt-1">{currentJob && currentJob.ID ? currentJob.ID : 'NULL'}</span><span className="font-n27-extralight float-right pt-1">ID_</span>
                        </p>
                        <svg className="w-full h-10">
                            <defs>
                                <marker
